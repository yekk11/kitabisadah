"""
Django settings for kitabisadah project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-+i2ec3=iupix^sc3%n+mpjj+-w@@@l&gd&%ke3+#x%#71kc03&')
...
WSGI_APPLICATION = 'kitabisadah.wsgi.application'
